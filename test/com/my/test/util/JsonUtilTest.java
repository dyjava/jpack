...
public class JsonUtilTest {
	...
	public void obj2XMLTest(){
		...
		String json = JsonUtil.obj2XML(u) ;
		System.out.println(json.toString()) ;
	...
	public void json2XMLTest(){
		...
		System.out.println("==========json2XMLTest==========") ;
		String json = JsonUtil.obj2json(u) ;
		System.out.println(json) ;
		String xml = JsonUtil.objJson2XML(json,"Result") ;
		System.out.println(xml) ;
		
	}

	@Test
	public void json2XML2Test(){
		List<Object> list = new ArrayList<Object>() ;
		list.add("first");
		list.add("second");
		list.add("北京");
		...
		System.out.println("==========json2XML2Test==========") ;
		System.out.println(json) ;
